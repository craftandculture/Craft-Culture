...
import { IconArrowLeft, IconLogout, IconMenu2, IconSettings, IconUser } from '@tabler/icons-react';
...
const WMSHeader = ({ userName }: WMSHeaderProps) => {
  ...
  return (
    <>
      ...
      <PrinterSettings open={printerSettingsOpen} onOpenChange={setPrinterSettingsOpen} />
    </>
  );
};
