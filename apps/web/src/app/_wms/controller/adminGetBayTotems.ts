...
/**
 * Get bay totems for printing - groups locations by aisle+bay
 *
 ...
 *
 * @example
 *   // Get all rack bay totems
 *   await trpcClient.wms.admin.labels.getBayTotems.query({});
 *
 *   // Get specific aisle
...
export default adminGetBayTotems;
