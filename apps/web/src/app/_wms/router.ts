...
import adminSetPricingRelease from './controller/adminSetPricingRelease';
...
import adminUpdateProductName from './controller/adminUpdateProductName';
...
const stockPricingRouter = createTRPCRouter({
  ...
  setTransferPrice: adminSetTransferPrice,
