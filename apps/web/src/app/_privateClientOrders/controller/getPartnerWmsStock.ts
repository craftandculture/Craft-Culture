...
/**
 * Get WMS stock for the current wine partner.
 *
 * Groups stock by LWIN18 + caseConfig and sums available cases across locations.
 * Only returns products with available stock > 0.
 */
const getPartnerWmsStock = winePartnerProcedure
  .input(inputSchema)
...
export default getPartnerWmsStock;
