...
import PartnerContactsSection from '../wine-partners/PartnerContactsSection';
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6 sm:mb-8">
          <div>
            ...
            <Typography variant="bodyMd" colorRole="muted">
              Members of the Private Cellar programme, and the wine they hold with us
            </Typography>
          </div>
            ...
            <Dialog open={isCreateDialogOpen} onOpenChange={setIsCreateDialogOpen}>
              <DialogTrigger asChild>
                <Button variant="default" colorRole="brand">
                  <ButtonContent iconLeft={IconPlus}>Add Collector</ButtonContent>
                </Button>
              </DialogTrigger>
              <DialogContent className="sm:max-w-2xl max-h-[90vh] overflow-y-auto">
                ...
                >
                  ...
                  <div className="flex justify-end gap-2 pt-4 border-t border-border-muted">
                    ...
                    >
                      <ButtonContent>
                        {isCreating ? 'Creating...' : 'Add Collector'}
                      </ButtonContent>
                    </Button>
                  </div>
                </form>
        ...
        <Card>
          <CardContent className="space-y-4 p-6">
            ...
            <Typography variant="bodySm" className="text-text-muted">
              {isLoading ? 'Loading...' : `${partners.length} collectors found`}
            </Typography>
          </CardContent>
        </Card>
          ...
          <Card>
            <CardContent className="p-6 text-center">
              ...
              <Typography variant="bodyMd" className="text-text-muted">
                No wine collectors found. Click &quot;Add Collector&quot; to create one.
              </Typography>
            </CardContent>
          </Card>
        ) : (
