...
export const buttonStyles = tv({
  ...
  variants: {
    ...
    variant: {
      default:
        'border-x border-b-2 border-t active:border-b data-[state=open]:border-b',
      ghost:
        'border-x border-b-2 border-t hover:border hover:border-b-2 [&:not([data-state=open]):not(:hover)]:border-transparent [&:not([data-state=open]):not(:hover)]:bg-transparent',
      outline: 'border',
    },
    size: {
