...
const bannerStyles = tv({
  ...
  variants: {
    colorRole: {
      ...
      success:
        'bg-surface-success text-text-success border-border-success/25 border',
      danger:
        'bg-surface-danger text-text-danger border-border-danger/25 border',
      warning:
        'bg-surface-warning text-text-warning border-border-warning/25 border',
    },
    size: {
      sm: 'px-2.5 py-2',
