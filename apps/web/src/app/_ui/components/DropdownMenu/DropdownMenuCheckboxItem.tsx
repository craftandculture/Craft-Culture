...
export const dropdownMenuCheckboxItemStyles = tv({
  slots: {
    wrapper:
      'outline-hidden data-disabled:pointer-events-none data-disabled:opacity-50 bg-fill-primary focus:text-text-primary hover:bg-fill-primary-hover active:bg-fill-primary-active relative flex cursor-pointer select-none items-center gap-1.5 rounded-lg px-2.5 py-1.5 transition-colors',
