...
export const dialogContentStyles = tv({
  slots: {
    ...
    content:
      'border-border-primary bg-surface-primary ring-border-primary/50 w-lg flex max-h-full max-w-full grow flex-col overflow-hidden rounded-lg border-2 border-b-4',
