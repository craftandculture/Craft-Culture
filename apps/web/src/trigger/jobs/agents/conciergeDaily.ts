...
/**
 * Core Concierge analysis logic shared between scheduled and on-demand runs
 */
const runConciergeAnalysis = async () => {
...
/**
 * On-demand Concierge task — triggered via REST API from the dashboard "Run Now" button
 */
